package dk.easj.anbo.nullsafetylateinitexample
...
class FirstFragment : Fragment() {
    ...
    private fun doIt() {
        ...
        //var name: String = null // Null can not be a value of a non-null type
        var length = name.length

        val input: String = binding.nameEditText.text.toString().trim()
